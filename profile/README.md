...
| [materials-discovery-skills](https://github.com/Material-Intelligence/materials-discovery-skills) | `matdisc`: an agent-drivable workflow for generative structure design, MLIP prescreening and DFT validation of inorganic semiconductors, packaged as seven Claude Code skills (from arXiv:2606.10251) | MIT |
